...
-- 1 - BUSCAR TODOS OS FORNECEDORES CADASTRADOS X PRODUTOS COMPRADOS
...
-- 4 - SITUACAO DO PEDIDO DE VENDA
SELECT PV.COD_PEDIDO_VENDA, PV.DATA_PEDIDO, PV.VLR_PEDIDO_VENDA, C.NOME AS NOME_CLIENTE, SP.STATUS_PEDIDO
FROM PEDIDO_VENDA PV
...
RIGHT OUTER JOIN ITEM_PEDIDO_COMPRA IPC ON IPC.COD_PEDIDO_COMPRA = PC.COD_PEDIDO_COMPRA
...
-- 2 - TODOS OS PEDIDOS DE VENDAS MESMO SEM VENEDOR CADASTRADO
SELECT V.NOME AS NOME_VENDEDOR, PV.COD_PEDIDO_VENDA, PV.DATA_PEDIDO
FROM PEDIDO_VENDA PV
...
FULL OUTER JOIN ITEM_PEDIDO_COMPRA IPC ON IPC.COD_PEDIDO_COMPRA = PC.COD_PEDIDO_COMPRA
